...
import {
  ...
  updateExpense,
  updateExpenseStatus,
} from "@/api/Services/Expence/expence";
...
const ExpenseManagement = () => {
  ...
  const exportToExcel = () => {
    ...
    const data = expenses.map((expense) => ({
      ...
      Hotel: expense.hotelId?.name || expense.hotelId?.hotelName || "N/A",
    ...
    <div className="flex-1 p-6 bg-gray-50">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {Math.round(
                (getApprovedAmount() / (getTotalAmount() || 1)) * 100
              )}
              % of total
            </p>
          </CardContent>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {Math.round((getPendingAmount() / (getTotalAmount() || 1)) * 100)}
              % of total
            </p>
          </CardContent>
        </Card>
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-red-600">
              {formatCurrency(getRejectedAmount())}
            </div>
            <p className="text-xs text-muted-foreground">
              {Math.round(
                (getRejectedAmount() / (getTotalAmount() || 1)) * 100
              )}
              % of total
            </p>
          </CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Track and manage your hotel expenses
          </CardDescription>
        </CardHeader>
        <CardContent>
                ...
                {expenses.length > 0 ? (
                  expenses.map((expense) => (
                    <tr key={expense._id} className="border-b hover:bg-gray-50">
                      ...
                      <td className="py-3 px-4">
                        {expense.hotelId?.name ||
                          expense.hotelId?.hotelName ||
                          "N/A"}
                      </td>
                      <td className="py-3 px-4 font-medium">
          ...
          <div className="flex justify-between items-center mt-4">
            <div className="text-sm text-gray-500">
              ...
              of {pagination.totalExpenses} expenses
            </div>
            <div className="flex space-x-2">
              <Button
                variant="outline"
